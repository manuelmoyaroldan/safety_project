...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__company_component__ = __webpack_require__(1538);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__company_dialog__ = __webpack_require__(1539);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__company_routing_module__ = __webpack_require__(1555);
...
/* harmony export (binding) */ __webpack_require__.d(exports, "CompanyModule", function() { return CompanyModule; });
...
var CompanyModule = (function () {
    ...
    CompanyModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [__WEBPACK_IMPORTED_MODULE_5__company_component__["a" /* CompanyComponent */], __WEBPACK_IMPORTED_MODULE_6__company_dialog__["a" /* CompanyDialog */]],
            exports: [__WEBPACK_IMPORTED_MODULE_6__company_dialog__["a" /* CompanyDialog */]],
            entryComponents: [__WEBPACK_IMPORTED_MODULE_6__company_dialog__["a" /* CompanyDialog */]],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__company_service__ = __webpack_require__(1540);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__company_dialog__ = __webpack_require__(1539);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_material__ = __webpack_require__(314);
...
var CompanyComponent = (function () {
    function CompanyComponent(_Service, viewContainerRef, dialog) {
    ...
    CompanyComponent.prototype.open_Dialog = function (valueRec) {
        var _this = this;
        var config = new __WEBPACK_IMPORTED_MODULE_3__angular_material__["MdDialogConfig"]();
        config.viewContainerRef = this.viewContainerRef;
        this.dialogRef = this.dialog.open(__WEBPACK_IMPORTED_MODULE_2__company_dialog__["a" /* CompanyDialog */], config);
        this.dialogRef.componentInstance.current = JSON.parse(JSON.stringify(valueRec));
        this.dialogRef.afterClosed().subscribe(function (result) {
            if (result != undefined) {
                if (_this.current.companyId != undefined) {
    ...
    CompanyComponent.prototype.click_Add = function (event) {
        this.current = {};
        this.open_Dialog(this.current);
    };
    CompanyComponent.prototype.click_Edit = function (valueRec) {
        this.current = valueRec;
        this.open_Dialog(this.current);
    };
    CompanyComponent.prototype.click_DeActivate = function (valueRec) {
    ...
    CompanyComponent.prototype.click_Activate = function (valueRec) {
    ...
    CompanyComponent.prototype.click_Delete = function (valueRec) {
        var _this = this;
        this._Service
            .delete(valueRec)
            .then(function () {
            _this.list = _this.list.filter(function (h) { return h.companyId !== valueRec.companyId; });
            _this.selected = {};
        });
    };
    CompanyComponent.prototype.onCancel = function (event) {
        this.show_dialog = false;
    };
    CompanyComponent.prototype.onRowSelect = function (event) {
        this.selected = event.data;
    };
    CompanyComponent.prototype.onRowUnselect = function (event) {
        this.selected = {};
    };
    CompanyComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.selected.companyId != undefined) {
    ...
    CompanyComponent.prototype.deactivate = function () {
        var _this = this;
    ...
    CompanyComponent.prototype.activate = function () {
        var _this = this;
    ...
    CompanyComponent.prototype.delete = function () {
        ...
        this._Service
            ...
            .then(function () {
            _this.list = _this.list.filter(function (h) { return h.companyId !== _this.selected.companyId; });
            _this.selected = {};
        });
    };
...
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return CompanyDialog; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CompanyDialog = (function () {
    function CompanyDialog(_Service, dialogRef, _snackbar) {
        this._Service = _Service;
        this.dialogRef = dialogRef;
        this._snackbar = _snackbar;
        this.current = {};
    }
    CompanyDialog.prototype.click_Close = function () {
        this.dialogRef.close();
    };
    CompanyDialog.prototype.click_Save = function () {
        var _this = this;
        if (this.current.companyId != undefined) {
            this._Service.update(this.current)
    ...
    CompanyDialog = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__company_service__["a" /* CompanyService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__company_service__["a" /* CompanyService */]) === 'function' && _a) || Object, (typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["MdDialogRef"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_material__["MdDialogRef"]) === 'function' && _b) || Object, (typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_material__["MdSnackBar"] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_2__angular_material__["MdSnackBar"]) === 'function' && _c) || Object])
    ], CompanyDialog);
...
var CompanyService = (function () {
    function CompanyService(_http, _conf) {
        ...
        this._http = _http;
        this._conf = _conf;
        this.BaseUrl = this._conf.Server + 'api/company';
        this.getAll = function () {
            return _this._http.get(_this.BaseUrl).map(function (res) { return res.json(); }).catch(_this.handleError);
        };
    }
    CompanyService.prototype.update = function (current) {
        return this._http.put(this.BaseUrl + '/' + current.companyId, current).map(function (res) { return res.json(); }).catch(this.handleError);
    };
    CompanyService.prototype.deactivate = function (current) {
        return this._http.put(this.BaseUrl + '/deactivate/' + current.companyId, current).map(function (res) { return res.json(); }).catch(this.handleError);
    };
    CompanyService.prototype.activate = function (current) {
        return this._http.put(this.BaseUrl + '/activate/' + current.companyId, current).map(function (res) { return res.json(); }).catch(this.handleError);
    };
    CompanyService.prototype.create = function (company) {
        return this._http.post(this.BaseUrl, company).map(function (res) { return res.json(); }).catch(this.handleError);
    };
    CompanyService.prototype.delete = function (current) {
        return this._http.delete(this.BaseUrl + '/' + current.companyId).toPromise().then(function () { return null; }).catch(this.handleError);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__company_component__ = __webpack_require__(1538);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return CompanyRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
