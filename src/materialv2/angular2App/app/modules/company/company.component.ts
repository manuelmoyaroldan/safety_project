...
export class CompanyComponent implements OnInit {
    ...
    constructor(private _Service: CompanyService, private viewContainerRef: ViewContainerRef, private dialog: MdDialog) { }
    ...
    open_Dialog(valueRec: any) {
        ...
        this.dialogRef.afterClosed().subscribe(result => {
            if (result != undefined) {
                if (this.current.companyId != undefined) { //Edit
    ...
    click_Delete(valueRec: any) {
        this._Service
            .delete(valueRec)
            .then(() => {
                this.list = this.list.filter(h => h.companyId !== valueRec.companyId);
                this.selected = {};
            });
    }
